...
class LoginController extends CircuitoController {
   ...
   public function validarSenhaAction() {
    ...
    public function consultarOrdenacaoTrezeAction(){
		...
		if($request->isPost()){		
			...
			if($pessoa && $pessoa->verificarSeTemAlgumaResponsabilidadeAtiva()){				                
				...
				foreach($responsabilidades as $grupoResponsavel){
					if($grupoResponsavel->getGrupo()->getEntidadeAtiva()->getEntidadeTipo(true)->getId() !== EntidadeTipo::secretario){
...
//						|| $turmaPessoa->getTurma()->getGrupo()->getGrupoIgreja()->getId() === 26374  // alagoas
	...
	public function checkoutAction() {
		...
		if ($request->isPost()) {
			...
			$nomeProduto = '';
			switch($produto_id){
	case self::$PRODUTO_TUDO: $nomeProduto = 'Instituto de Vencedores Completo'; break;
	case self::$PRODUTO_TUDO_PARCELADO: $nomeProduto = 'Instituto de Vencedores Completo'; break;
	case self::$PRODUTO_MODULO_1: $nomeProduto = 'Instituto de Vencedores Módulo 1'; break;
	case self::$PRODUTO_PARCELA_1_MODULO_1: $nomeProduto = 'Instituto de Vencedores Módulo 1 Parcela 1'; break;
	case self::$PRODUTO_PARCELA_2_MODULO_1: $nomeProduto = 'Instituto de Vencedores Módulo 1 Parcela 2'; break;
	case self::$PRODUTO_PARCELA_3_MODULO_1: $nomeProduto = 'Instituto de Vencedores Módulo 1 Parcela 3'; break;
	case self::$PRODUTO_MODULO_2: $nomeProduto = 'Instituto de Vencedores Módulo 2'; break;
	case self::$PRODUTO_PARCELA_1_MODULO_2: $nomeProduto = 'Instituto de Vencedores Módulo 2 Parcela 1'; break;
	case self::$PRODUTO_PARCELA_2_MODULO_2: $nomeProduto = 'Instituto de Vencedores Módulo 2 Parcela 2'; break;
	case self::$PRODUTO_PARCELA_3_MODULO_2: $nomeProduto = 'Instituto de Vencedores Módulo 2 Parcela 3'; break;
	case self::$PRODUTO_MODULO_3: $nomeProduto = 'Instituto de Vencedores Módulo 3'; break;
	case self::$PRODUTO_PARCELA_1_MODULO_3: $nomeProduto = 'Instituto de Vencedores Módulo 3 Parcela 1'; break;
	case self::$PRODUTO_PARCELA_2_MODULO_3: $nomeProduto = 'Instituto de Vencedores Módulo 3 Parcela 2'; break;
	case self::$PRODUTO_PARCELA_3_MODULO_3: $nomeProduto = 'Instituto de Vencedores Módulo 3 Parcela 3'; break;
	case self::$P2RODUTO_TUDO: $nomeProduto = 'Instituto de Vencedores Completo'; break;
	case self::$P2RODUTO_TUDO_PARCELADO: $nomeProduto = 'Instituto de Vencedores Completo'; break;
	case self::$P2RODUTO_MODULO_1: $nomeProduto = 'Instituto de Vencedores Módulo 1'; break;
	case self::$P2RODUTO_PARCELA_1_MODULO_1: $nomeProduto = 'Instituto de Vencedores Módulo 1 Parcela 1'; break;
	case self::$P2RODUTO_PARCELA_2_MODULO_1: $nomeProduto = 'Instituto de Vencedores Módulo 1 Parcela 2'; break;
	case self::$P2RODUTO_PARCELA_3_MODULO_1: $nomeProduto = 'Instituto de Vencedores Módulo 1 Parcela 3'; break;
	case self::$P2RODUTO_MODULO_2: $nomeProduto = 'Instituto de Vencedores Módulo 2'; break;
	case self::$P2RODUTO_PARCELA_1_MODULO_2: $nomeProduto = 'Instituto de Vencedores Módulo 2 Parcela 1'; break;
	case self::$P2RODUTO_PARCELA_2_MODULO_2: $nomeProduto = 'Instituto de Vencedores Módulo 2 Parcela 2'; break;
	case self::$P2RODUTO_PARCELA_3_MODULO_2: $nomeProduto = 'Instituto de Vencedores Módulo 2 Parcela 3'; break;
	case self::$P2RODUTO_MODULO_3: $nomeProduto = 'Instituto de Vencedores Módulo 3'; break;
	case self::$P2RODUTO_PARCELA_1_MODULO_3: $nomeProduto = 'Instituto de Vencedores Módulo 3 Parcela 1'; break;
	case self::$P2RODUTO_PARCELA_2_MODULO_3: $nomeProduto = 'Instituto de Vencedores Módulo 3 Parcela 2'; break;
	case self::$P2RODUTO_PARCELA_3_MODULO_3: $nomeProduto = 'Instituto de Vencedores Módulo 3 Parcela 3'; break;
			}	
			...
			if(
				...
				if($pessoa = $this->getRepositorio()->getPessoaORM()->encontrarPorEmail($email)){
					...
					if($turmaPessoa = $pessoa->getTurmaPessoaAtivo()){
						...
						$numeroIdentificador = $this->getRepositorio()->getFatoCicloORM()->montarNumeroIdentificador($this->getRepositorio(), $turmaPessoa->getPessoa()->getGrupoPessoaAtivo()->getGrupo());
						...
						$fatoFinanceiroInstituto->setMes($mes);
						$fatoFinanceiroInstituto->setAno($ano);
	...
	public function lideresSedeAction() {
		set_time_limit(0);
		ini_set('memory_limit', '-1');
		ini_set('max_execution_time', '180');
		...
		$grupoCoordenacao = $this->getRepositorio()->getGrupoORM()->encontrarPorId(1225);
		$grupoPaiFilhoFilhos = $grupoCoordenacao->getGrupoPaiFilhoFilhosAtivosReal();
			foreach ($grupoPaiFilhoFilhos as $grupoPaiFilhoFilho12) {
				$grupoIgreja = $grupoPaiFilhoFilho12->getGrupoPaiFilhoFilho();
				$numeroIdentificador = $this->getRepositorio()->getFatoCicloORM()->montarNumeroIdentificador($this->getRepositorio(), $grupoIgreja);
