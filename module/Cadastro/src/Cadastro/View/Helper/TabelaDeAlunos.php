...
class TabelaDeAlunos extends AbstractHelper {
    ...
    public function renderHtml() {
        ...
        $html .= '<thead>';
        $html .= '<tr>';
        $html .= '<th class = "hidden-xs">' . $this->view->translate(ConstantesCadastro::$TRADUCAO_MATRICULA) . '</th>';
        $html .= '<th>' . $this->view->translate(ConstantesCadastro::$TRADUCAO_NOME) . '</th>';
        $html .= '<th class ="hidden-xs">' . $this->view->translate(ConstantesCadastro::$TRADUCAO_DATA_NASCIMENTO) . '</th>';
        $html .= '<td></td>';
        $html .= '</tr>';
        $html .= '</thead>';
        $html .= '<tbody>';
        ...
        if ($this->getForm()->getAlunos()) {
            ...
            echo '<tr><td>' . $this->view->translate(ConstantesCadastro::$TRADUCAO_SEM_ALUNOS_CADASTRADOS) . '</td></tr>';
        }
        $html .= '</tbody>';
        $html .= '</table>';
        $html .= '';
